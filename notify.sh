...
url=https://api.github.com/repos/quixoter/dialog-tree-checkbox/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "dialog-tree-checkbox更新", "text": "@所有人\n# [dialog-tree-checkbox]('$html_url')\n'$body'"}}'
